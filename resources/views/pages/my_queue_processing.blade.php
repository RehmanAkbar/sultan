                ...
                <div class="col-lg-7">
                    <div class="col-lg-12">
                        ...
                        <form class="shiping_form" id="shiping_form">
                            ...
                            <div class="col-sm-4" id="field_set">
                                <select class="cities form-control" name="state"                                 <input class="form-control" placeholder="City" name="city" type="text" value="{{ $shipping_address->city }}" >
>
...
<div class="container" style="margin-bottom: 2%;" >
    ...
    @endif
        <!--<h1 style="padding-bottom: 1%;margin-left: 9%">Processed Queued Orders</h1>-->
        <br/><br/>
                ...
                <div class="panel-heading" style="background-color: lightgrey;">
                    <div class="row">
                        <div class="col col-xs-6">
                            <h3 class="panel-title">My Processed Queues</h3>
                        </div>
