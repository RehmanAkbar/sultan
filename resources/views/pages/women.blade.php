...
<div class="col-lg-12" style="padding:0px;">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12" id="bgperfume_women">
        <div class="col-lg-12" id="women_top">
            <h3 style="color:#fdc18b; margin-top: 0px; ">Pakistan's First Perfume Subscription Service</h3>
            <h3 style="color:#fdc18b; " >How do I get my perfumes?</h3>
        </div>
        <div class="col-lg-1 col-md-1 col-sm-1 " id="signup_perfume">
            <span style="font-size: 40px; color: #fdc18b;">&#9312;</span>

        </div>
        <div class="col-lg-5 col-md-5 col-lg-5" id="signup_perfume">
...
<div class="col-lg-12">
    <div class="container">
        <div class="col-lg-12">
            ...
            <p align="center">Upgrade your game with the colognes from these top designer brands. Let’s face it, Axe could use some help.</p>
        </div>
    </div>
</div>
    ...
    <div class="slider">
        ...
        <div class="slide">
            ...
            <div class="row" style="margin-top: 40px;">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-6" id="div_product">
                    <div class="media" id="mobileview"><img class="media__image" src="images/brand_logos/logo17.png" id="mobileview">
                        <div class="media__body" align="center">
                             <p id="productscolor">5th Avenue by -For Women</p>  
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-xs-6" id="div_product">
                    <div class="media" id="mobileview"><img class="media__image" src="images/brand_logos/logo18.png" id="mobileview">
                        <div class="media__body" align="center">
                             <p id="productscolor">Lacoste Essential Cologne </p> 
                             <p id="productscolor">Lascoste White  </p> 
                             <p id="productscolor">Lascoste Red  </p>  
                             <p id="productscolor">Lascoste Yellow</p>  
                        </div>
                    </div>
                </div>
                <div class="img col-lg-3 col-sm-6 col-xs-6 " id="div_product">
                    <div class="media" id="mobileview"><img class="media__image" src="images/brand_logos/logo19.png" id="mobileview">
                        <div class="media__body" align="center">
                             <p id="productscolor">1881 by - Classic/Office/Wedding</p> 
            ...
            <div class="row" style="margin-top: 40px;">
                <div class="img col-lg-3 col-sm-6 col-xs-6" id="div_product">
                    ...
                    <div class="media" id="mobileview"><img class="media__image" src="images/brand_logos/logo22.png" id="mobileview">
                        <div class="media__body" align="center">
                             <p id="productscolor">Desire Colonge</p> 
                             <p id="productscolor">Desire Blue Colonge</p> 
                             <p id="productscolor">Dunhill Black Colonge</p>  
                             <p id="productscolor">Dunhill Icon Colonge</p>  
                        </div>
                    </div>
                </div>
                <div class="img col-lg-3 col-sm-6 col-xs-6" id="div_product">
                    ...
                    <div class="media" id="mobileview"><img class="media__image" src="images/brand_logos/logo23.png" id="mobileview">
                        <div class="media__body" align="center">
                             <p id="productscolor">Grey Flannel Colonge</p>  
                        </div>
                    </div>
                </div>
                <div class="img col-lg-3 col-sm-6 col-xs-6" id="div_product">
...
<div class="col-lg-12 col-md-12 col-sm-12" id="bg_lowerbannerw">
