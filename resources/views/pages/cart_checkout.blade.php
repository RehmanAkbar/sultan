                        ...
                        <div class="col-sm-12 col-md-10 col-md-offset-1">
                            <table class="table table-hover">
                                    ...
                                    @foreach(Cart::content() as $row)
                                        <tr>
                                            <td class="col-sm-8 col-md-6">
                                                <div class="media">
                                                    <a class="thumbnail pull-left" href="#"> <img class="media-object" src="{{URL::asset($row->options['image'])}}" style="width: 72px; height: 72px;"> </a>
                                            ...
                                            <td class="col-sm-1 col-md-1 "><strong>Rs. {{$row->price}}</strong></td>
                                            <td class="col-sm-1 col-md-1">
                                                <button data-rowid="{{$row->rowId}}" type="button" class="remove_item btn btn-danger">
                                ...
                                <tr>
                                    ...
                                    <td>   </td>
                                    <td><h3>Total</h3></td>
                                    <td class="text-right"><h3><strong>Rs. {{Cart::total()}}</strong></h3></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    <td>
                                        <button onclick="window.location.href = '{{route("perDetail")}}';" type="button" class="btn btn-default">
